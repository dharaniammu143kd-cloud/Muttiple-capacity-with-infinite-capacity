...
```
## Output :
<img width="943" height="310" alt="image" src="https://github.com/user-attachments/assets/bc7ced51-98d0-43a5-9e65-9b034192acc5" />

## Result : 

Thus, the average number of materials in the system, average number of materials in the conveyor, waiting time of each material in the system, and waiting time of each material in the conveyor were calculated successfully using the queuing model for the given Poisson arrival and exponential service times.
